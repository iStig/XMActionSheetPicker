...
#pragma mark -- AbstractActionSheetPicker
...
- (void)presentActionSheet:(XMActionSheet *)actionSheet;
...
@implementation XMAbstractActionSheetPicker
...
- (void)configureAndPresentActionSheetForView:(UIView *)aView {
    ...
    _actionSheet = [[XMActionSheet alloc] initWithView:aView windowLevel:self.windowLevel];
